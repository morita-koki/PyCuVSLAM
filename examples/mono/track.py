...
def _create_camera_from_config(config: dict) -> cuvslam.Camera:
    ...
    cam.distortion = cuvslam.Distortion(
        ...
        config['distortion_coefficients'][:2] + [config['distortion_coefficients'][4]] + config['distortion_coefficients'][2:4]
    )
...
output_file = "cuvslam_output.rrd"
rr.save(output_file)
# rr.connect_tcp("10.255.255.254:9876")
...
euroc_tracking_mode = cuvslam.Tracker.OdometryMode(3)
